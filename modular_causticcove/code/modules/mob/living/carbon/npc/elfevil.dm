...
/mob/living/carbon/human/species/elfevil/npc
	faction = list("elfbandit", "station")
	aggressive = 1
	rude = TRUE
	mode = NPC_AI_IDLE
	wander = FALSE
...
/datum/outfit/job/roguetown/elfevil/npc/pre_equip(mob/living/carbon/human/H) //gives some default skills and equipment for player controlled orcs
	H.STASTR = 10
